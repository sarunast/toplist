...
return array(
    ...
    */
    ...
    'collections' => array(
        ...
        'application' => function($collection)
        {
            ...
            {
                $collection->stylesheet('fuelux.css');
                //$collection->add('less/build.less')->apply('Less');
                $collection->stylesheet('bootstrap.min.css');
                $collection->stylesheet('top.css');
                $collection->stylesheet('demo.css');
            ...
            {
                /*$collection->requireDirectory()->except('modernizer.js');*/

                $collection->javascript('jquery-1.10.2.min.js');
                $collection->javascript('jquery-ui-1.10.2.min.js');
                $collection->javascript('jquery.validate.min.js');
                $collection->javascript('bootstrap.min.js');
                $collection->javascript('angular.min.js');
                $collection->javascript('ng-infinite-scroll.min.js');
                $collection->javascript('app.js')->apply('JsMin');
                $collection->javascript('socialite.min.js');
                $collection->javascript('jquery.livequery.min.js');
        ...
        'statistics' => function($collection)
        {
            ...
            $directory = $collection->directory('assets/stylesheets', function($collection)
            {
                $collection->stylesheet('morris-0.4.3.min.css');
            });
            ...
            $directory = $collection->directory('assets/javascripts', function($collection)
            {
                $collection->javascript('raphael-min.js');
                $collection->javascript('statistics.js')->apply('JsMin');
                $collection->javascript('morris-0.4.3.min.js');
        ...
        'vote' => function($collection)
        {
            ...
            $directory = $collection->directory('assets/javascripts', function($collection)
            {
                ...
                $collection->javascript('bootstrap.min.js');
                $collection->javascript('jquery.validate.min.js');
                $collection->javascript('fingerprint.min.js');
            });


        },

        'createServer' => function($collection)
        {
            // Switch to the stylesheets directory and require the "less" and "sass" directories.
            // These directories both have a filter applied to them so that the built
            // collection will contain valid CSS.
            ...
            $directory = $collection->directory('assets/javascripts', function($collection)
            {
                ...
                $collection->javascript('loader.min.js');
                $collection->javascript('additional-methods.min.js');
                $collection->javascript('createServer.js')->apply('JsMin');
            });
    ...
    */
    ...
    'production' => array('production', 'prod', 'saruna'),
