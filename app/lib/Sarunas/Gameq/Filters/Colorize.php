<?php namespace Sarunas\Gameq\Filters;
/**
...
class Colorize {
	...
	public static function filter(&$data, $args) {
		...
		switch($data['info']['protocol']) {
			...
			case 'quake3':
			case 'doom3':
				array_walk_recursive($data, "\\Sarunas\\Gameq\\filters\\Colorize::strip", array('t' => 'quake'));
				break;
			...
			case 'gamespy2':
				array_walk_recursive($data, "\\Sarunas\\Gameq\\filters\\Colorize::strip", array('t' => 'ut'));
				break;
			case 'lfs':
				array_walk_recursive($data, "\\Sarunas\\Gameq\\filters\\Colorize::strip", array('t' => 'lfs'));
				break;
			default:
				break;
		}
